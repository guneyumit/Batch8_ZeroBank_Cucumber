...
public class AccountSummary_StepDefs {
    ...
    public void the_user_should_be_able_to_see_following_credit_accounts_columns(List<String> expectedCreditAccountsColumns) {
        List<String> actualCreditAccountsColumns = accountSummaryPage.getCreditAccountsColumnsTexts();
        Assert.assertEquals(expectedCreditAccountsColumns,actualCreditAccountsColumns);
    }
}
